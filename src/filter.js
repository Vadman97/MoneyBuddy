...
const awards = JSON.parse(`[{
	...
	"Details": "ARIT Fellowships for Research in Turkey are offered for research in ancient, medieval, or modern times, in any field of the humanities and social sciences.  Post-doctoral and advanced doctoral fellowships may be held for various terms, for terms from one month up to one academic year.  Stipends range from $2,500 to $15,500.",
	...
	"Details": "Gain hands-on policy experience, help develop and execute solutions to address societal challenges, and join a strong corps of over 3,100 policy-savvy alumni fellows working across sectors to serve the nation and citizens around the world. Fellow contributions may include policy research, drafting briefings and reports, and implementing policies to enhance reproducible research through rigor and transparency. Fellows serve yearlong assignments in all three branches of the federal government in Washington D.C. and represent a broad range of backgrounds, disciplines and career stages. STPF is seeking candidates with strong STEM credentials, an interest in career transformation and a desire to enhance federal policy.",
	...
	"Details": "The AERA Grants Program has supported, trained, and encouraged researchers from a variety of disciplines to conduct education policy- and practice-related research using quantitative methods with data from the data sets sponsored by NSF and NCES.The goals of the program are: 1.to stimulate research on U.S. education issues using data from the large-scale, national and international data sets supported by the National Center for Education Statistics (NCES), NSF, and other federal agencies, and2.to increase the number of education researchers using these data sets.",
	...
	"Details": "AHRQ provides support to individuals for dissertation research in health services research as part of completing a research doctorate degree. Deadlines are February 1, May 1, August 1, and November 1, annually",
	...
	"Details": "The Albert Schweitzer Fellowship immerses a select group of graduate students in an experiential learning and leadership development program designed to increase and sharpen their skills and abilities to more effectively address the health needs of underserved people.",
	...
	"Details": "The purpose of the ASTR Research Fellowships is to underwrite some of the research expenses of scholars undertaking projects significant to the field of theatre and/or performance studies. The total award of up to $3,000 may be divided among multiple winners. The fellowships can be used in conjunction with funding from other sources. Anyone holding a terminal degree who has been a member of ASTR for at least 3 of the last 5 years is eligible to apply.",
	...
	"Details": "Public Allies is a national movement grounded in the conviction that everyone leads. We believe that everyone can make a difference and can work to inspire more citizens to believe in themselves, step up, and act. Throughout our nations history, lasting social change has always resulted from the courageous acts of many, not just the inspiration of the few. Our mission is to create a just and equitable society and the diverse leadership to sustain it. We are changing the face and practice of leadership in communities across the country by demonstrating our conviction that everyone can lead, and that lasting social change results when citizens of all backgrounds step up, take responsibility, and work together. Our partnership with AmeriCorps dates back to its founding in 1994. Since then, our signature AmeriCorps Ally Program has identified thousands of diverse young adults and prepared them for leadership.",
	...
	"Details": "ARIT Summer Fellowships for Intensive Advanced Turkish Language at Bogazici University, Istanbul, summer 2017.  The program supports intensive study of advanced Turkish language at Bogazici University in Istanbul, Turkey, including air fare, tuition, and stipend.  The application deadline is February 5.",
	...
	"Details": "To promote awareness of the achievements of Armenian Women, we are offering a scholarship of $500 to eligible students.The topic is Armenian Women: Not just a pretty face",
	...
	"Details": "The American-Scandinavian Foundation (ASF) is a publicly supported, nonprofit, organization that promotes international understanding through educational and cultural exchange between the U.S. and the Nordic countries.The ASF will offer around $300,000 to outstanding American students, scholars, professionals and artists for study and/or research in Denmark, Finland, Iceland, Norway or Sweden. Fellowships of up to $23,000 are intended to support an academic year-long stay, and priority is given to students at the graduate level who need to spend time at foreign academic or research institutions. Grants of up to $5,000 are considered more suitable for shorter research visits, both on the graduate or post-doctoral level. Funding is available to candidates in all fields.",
	...
	"Details": "The Benjamin A. Gilman International Scholarship provides awards for undergraduate students who are U.S. citizens and receiving Federal Pell Grant funding to participate in study abroad programs. The program encourages students to choose non-traditional study abroad destinations.",
	...
	"Details": "Boren Scholarships provide funding for U.S. undergraduate students to study in Africa, Asia, Central & Eastern Europe, Eurasia, Latin America, and the Middle East.  Boren Scholarships require rigorous language study and the majority of awardees spend a full academic year overseas.  Applicants must be matriculated in a U.S. college or university upon application and throughout the Boren Scholarship.  In exchange for funding, Boren Scholarship recipients commit to working in the federal government for at least one year after graduation. Boren Fellowships are for matriculated graduate students.",
	...
	"Details": "Boren Fellowships, an initiative of the National Security Education Program, provide unique funding opportunities for U.S. graduate students to study less commonly taught languages in world regions critical to U.S. interests, and underrepresented in study abroad, including Africa, Asia, Central and Eastern Europe, Eurasia, Latin America, and the Middle East. The countries of Western Europe, Canada, Australia, and New Zealand are excluded. Boren Fellows represent a vital pool of highly motivated individuals who wish to work in the federal national security arena. In exchange for funding, Boren Fellows commit to working in the federal government for at least one year after graduation.",
	...
	"Details": "The CCST Science & Technology Policy Fellowship provides year of public service and government leadership training for scientists and engineers",
	...
	"Details": "The Center for Engaged Scholarship dissertation fellowshipsare for Ph.D. students in the social sciences whose work is of high quality and that has the potential to contribute to making U.S. society less unequal, more democratic, and more environmentally sustainable.",
	...
	"Details": "The law firm of Chisholm Chisholm & Kilpatrick LTD awards a $1,000 Child of a Disabled Veteran Scholarship each year to one deserving applicant whose parent has a service-connected disability.The U.S. Department of Veterans Affairs reports that, in 2016, the U.S. has more than 20 million living veterans. As of 2015, almost one in four American veterans lived with a service-connected disability.In our ongoing work with veterans disabled from military service, we see firsthand the challenges our real-life national heroes and their families face. To demonstrate our gratitude for their parents service, we established this annual scholarship awarded to the son or daughter of a disabled American veteran.",
	...
	"Details": "Chisholm, Chisholm & Kilpatrick LTD will award an annual $1,500 scholarship to a deserving veteran enrolled in or accepted to a U.S law school. Veterans of all branches of the U.S Military are eligible to apply (Army, Navy, Air Force, Marine Corps and Coast Guard).",
	...
	"Details": "The Churchill Scholarship provides tuition and funding for 14 students each year toward graduate work in engineering, mathematics and the physical and natural sciences at Churchill College, Cambridge University. Funds cover all University and College tuition and fees (approximately $25,000). In addition, Scholars receive a living allowance of \u00a310,000 for nine-month programs, \u00a312,000 for eleven-month programs, and \u00a313,000 for twelve-month programs. Scholars also receive an allowance of up to $1,000 for travel to and from the United Kingdom, as well as reimbursement of application fees for a UK visa. The total award is worth approximately $45,000 to $50,000.Desired qualities are outstanding achievement in academic work as indicated by course grades, a capacity for original, creative work as shown by special recognitions or letters of references, and intellectual leadership, character and adaptability.",
	...
	"Details": "The Congress-Bundestag Youth Exchange for Young Professionals (CBYX) is a full year fellowship, funded by the U.S. Department of State and the German Bundestag. The fellowship is awarded annually to 75 American young professionals in a broad range of career fields. Fellowship includes: Two months of intensive German language training, four months of study at a German university or equivalent, five-month internship with a German company or organization in ones career field. Applicants should have clear career goals, some relevant experience in their career field, an interest in German and international affairs, and a strong sense of American identity. Previous German language knowledge is not required, but is preferred. Candidates in all fields encouraged to supply.",
	...
	"Details": "The Cultural Vistas Fellowship affords underrepresented U.S. university students the unique opportunity to advance their career goals, develop global competencies, and experience life in another culture. The program selects fellows to take part in this multinational professional development program that includes eight-week summer internships in Argentina, Germany, and India. This fellowship opportunity is funded by Cultural Vistas.",
	...
	"Details": "DAAD Research Grants are awarded to highly qualified candidates who have completed a Masters degree or Diplom, or in exceptional cases a Bachelors degree at the latest by the time they begin their grant-supported research, or those who have already completed a PhD (postdocs), or to individuals wishing to earn a doctoral degree in Germany,",
	...
	"Details": "The DAAD/AICGS Research Fellowship Program, funded by a generous grant from the Deutscher Akademischer Austauschdienst (DAAD), is designed to bring scholars and specialists working on Germany, Europe, and/or transatlantic relations to the American Institute for Contemporary German Studies in Washington DC for research stays of two consecutive months each. Fellowships include a monthly stipend of up to $4,725, depending on the seniority of the applicant; transportation to and from Washington; and office space at the Institute.",
	...
	"Details": "The DOD SMART program supports undergraduate and graduate students pursuing degrees in Science, Technology, Engineering and Mathematics (STEM) disciplines. The program aims to increase the number of civilian scientists and engineers working at DoD laboratories",
	...
	"Details": "The DOE CSGF is open to U.S. citizens or permanent resident aliens who plan full-time, uninterrupted study toward a Ph.D. at an accredited U.S. university. Applications from students in engineering and the physical, computer, mathematical or life sciences are encouraged to apply. The fellowship provides four years of support, but must be renewed each summer.",
	...
	"Details": "Since 2009, E4FC has developed resources to help undocumented students across the United States find scholarships to pay for college. These resources have been assembled and updated by undocumented young people who have participated in E4FCs various programs. Thanks to the support of students, educators and parents like you, in the past year alone our scholarship resources have been accessed over 60,000 times.",
	...
	"Details": "The Elizabeth Munsterberg Koppitz Fellowship program supports graduate research projects and scholarships in child psychology.",
	...
	"Details": "The Exploration Fund Grant is for graduate, post-graduate, doctorate and early career post-doctoral students. It provides grants in support of exploration and field research for those who are just beginning their research careers.",
	...
	"Details": "The German Chancellor Fellowship of the Alexander von Humboldt Foundation is targeted at university graduates from Brazil, China, India, Russia and the USA, who have already acquired initial leadership experience and are interested in spending a year working on research-based, self-developed projects with a host of their choice in Germany, under the patronage of the Chancellor of the Federal Republic of Germany. Participants must have received a Bachelors degree within twelve years of the program start date.",
	...
	"Details": "GoStartABlog is awarding a $1000 scholarship for the best essay on the topic Writing has given me the opportunity to.... To apply, please visit https://gostartablog.com/scholarship/ for more information and details on the application process.",
	...
	"Details": "The Program on Negotiation Graduate Research Fellowships provide support for one year of dissertation research and writing in negotiation and related topics in alternative dispute resolution and give fellows an opportunity to immerse themselves in the diverse resources available at PON.",
	...
	"Details": "For scholars who are preparing their PhD dissertation for publication, or who are embarking on new research projects. Postdoctoral fellowships support work based on the applicants research in China that aims to produce a scholarly text in English. A working knowledge of Chinese is required.Stipends may be used for travel, living expenses, and research costs. Other support may be accepted (sabbatical leave or other grants) but the total received cannot exceed the 125% of the fellows academic annual salary. There is no financial support for dependents.",
	...
	"Details": "The Hertog Foundation offers several highly competitive and selective educational programs for outstanding individuals who seek to influence the intellectual, civic, and political life of the United States. We offer programs in three main areas: Political Thought & Philosophy; War & Foreign Affairs; and Economics & Domestic Policy.Our programs include short-term seminars in New York City and Washington, DC as well as summer fellowships for college undergraduates and recent graduates.",
	...
	"Details": "The Foundation provides Fellowships to exceptionally talented individuals studying in the applied physical, biological and engineering sciences for graduate work leading to award of the PhD degree in applications of the physical sciences.The Graduate Fellowship Award is based on merit (not need) and consists of a cost-of-education allowance and a personal-support stipend.",
	...
	"Details": "The James Madison Memorial Fellowship Foundation offers $24,000 James Madison Graduate Fellowships to individuals desiring to become outstanding teachers of the American Constitution at the secondary school level. Fellowship applicants compete only against other applicants from the states of their legal residence. As funding permits, the Foundation plans to offer one fellowship per state per year. Applicants must be current teachers or planning to become a teacher (American history, American government, or civics classes at secondary level (grades 7-12).",
	...
	"Details": "The Winston Churchill Foundation of the United States is pleased to announce the launch ofthe Kanders Churchill Scholarship for the 2017 Churchill Scholarship competition, forattendance at Churchill College, University of Cambridge, in the 2018-19 academic year. The Kanders Churchill Scholarship is an exciting addition to the Churchill Scholarship programand builds upon the two days of science policy seminars and visits to UK governmentministries, which was introduced in the 2016-17 academic year for all Churchill Scholars. Applicants for the Kanders Churchill Scholarship must be US citizens who are seniors when they apply or have graduated with a degree in science, mathematics, or engineering, from any US institution within the past two years. Unlike the other Churchill Scholarships, there will be no application to the Churchill Foundation. Instead, candidates will tick a box on their Cambridge application.",
	...
	"Details": "ACLS invites applications for the eighth competition of the Mellon/ACLS Public Fellows program. This year, the program will place up to 25 recent PhDs from the humanities and humanistic social sciences in two-year term staff positions at partnering organizations in government and the nonprofit sector. Fellows will participate in the substantive work of these organizations and receive professional mentoring. Fellows receive a stipend of $67,500 per year, individual health insurance, a relocation allowance, and up to $3,000 to be used toward professional development activities over the course of the fellowship term.This initiative, made possible by a grant from The Andrew W. Mellon Foundation, aims to expand the role of doctoral education in the United States by demonstrating that the capacities developed in the advanced study of the humanities have wide application, both within and beyond the academy. The Mellon/ACLS Public Fellows program allows PhDs to gain valuable, career-building experience in fields such as public policy, development, conservation, arts and culture, and media.ACLS seeks applications from recent PhDs who aspire to careers in administration, management, and public service by choice rather than circumstance. Competitive applicants will have been successful in both academic and extra-academic experiences.",
	...
	"Details": "A two-year fellowship program for outstanding PhD students nominated by their universities. To be eligible for this fellowship, you must apply during your second or third year of PhD studies. Fellowships are granted by Microsoft Research at the discretion of Microsoft.",
	...
	"Details": "The Mount Vernon Leadership Fellows program is a competitive six week long summer leadership program that takes place just outside of Washington, D.C. at George Washingtons Mount Vernon. The program offers a small, select group of rising college juniors unparalleled opportunities in the nations capital and on the famous estate of the first President of the United States. The program provides housing, transportation, meals, and a $500 weekly stipend.",
	...
	"Details": "The Dissertation Fellowship Program seeks to encourage a new generation of scholars from a wide range of disciplines and professional fields to undertake research relevant to the improvement of education. These $27,500 fellowships support individuals whose dissertations show potential for bringing fresh and constructive perspectives to the history, theory, or practice of formal or informal education anywhere in the world. Applicants need not be citizens of the United States; however, they must be candidates for the doctoral degree at a graduate school within the United States.",
	...
	"Details": "ARIT / National Endowment for the Humanities Advanced Fellowships for Research in Turkey cover all fields of the humanities, including prehistory, history, art, archaeology, literature, and linguistics as well as interdisciplinary aspects of cultural history for applicants who have completed their academic training.  The fellowships may be held for terms ranging from four months to a full year.  Stipend per month is $4,200.",
	...
	"Details": "Young Explorers Grants (YEG) offer opportunities to individuals ages 18 to 25 to pursue research, conservation, and exploration-related projects consistent with National Geographics existing grant programs, including: the Committee for Research and Exploration (CRE), the Expeditions Council (EC), and the Conservation Trust (CT).",
	...
	"Details": "The National Humanities Center will offer up to 40 residential fellowships for advanced study in the humanities for the period September 2019 through May 2020. Applicants must have a doctorate or equivalent scholarly credentials. Mid-career and senior scholars are encouraged to apply. Emerging scholars with a strong record of peer-reviewed work may also apply. The Center does not support the revision of doctoral dissertations.",
	...
	"Details": "The National Physical Science Consortium is a partnership between government agencies and laboratories, industry, and higher education. NPSCs goal is to increase the number of American citizens with graduate degrees in the physical sciences and related engineering fields, emphasizing recruitment of a diverse applicant pool.",
	...
	"Details": "The NIH MD/PhD Partnership Training Program offers the opportunity for training, activities, and funding for MD/PhD students who conduct their PhD research in the Intramural Research Program of the National Institutes of Health (NIH).",
	...
	"Details": "NPSCs goal is to increase the number of American citizens with graduate degrees in the physical sciences and related engineering fields, emphasizing recruitment of a diverse applicant pool.",
	...
	"Details": "The NRC Research Associateship Programs (RAP) promote excellence in scientific and technological research conducted by the U.S. government through the administration of programs offering postdoctoral, and senior level research opportunities at sponsoring federal laboratories and affiliated institutions.",
	...
	"Details": "A two-year, non-residential Fellowship [that] will offer hands-on training, resources, and leadership development for a diverse set of community-minded rising stars organizers, inventors, artists, entrepreneurs, journalists, and more who are altering the civic engagement landscape. You will participate in a global cohort of leaders poised to change the civic engagement landscape.",
	...
	"Details": "The fellowship program is designed for individuals who demonstrate the potential to make significant contributions to the field of health services administration. By participating in Palmetto Healths program, the fellow learns firsthand about the operations, finance, and other significant areas of the healthcare delivery system.",
	...
	"Details": "The Paul & Daisy Soros Fellowships for New Americans program honors the contributions of immigrants and children of immigrants to the United States. Each year, we invest in the graduate education of 30 New Americans - immigrants and children of immigrants - who are poised to make significant contributions to U.S. society, culture, or other academic field. Each Fellow receives up to $90,000 in financial support over one to two years, and they join a strong alumni network of inspiring immigrants and children of immigrants working in a range of professional fields.",
	...
	"Details": "Phi Kappa Phi Study Abroad Grants are designed to help support undergraduates as they seek knowledge and experience in their academic fields by studying abroad. Seventy-five $1,000 grants are awarded each year.",
	...
	"Details": "To provide financial support to advanced PhD students whose research will advance knowledge of innovative and effective approaches to improve medication adherence.",
	...
	"Details": "The ProInspire Fellowship is a highly competitive one-year fellowship that:Places business professionals in targeted positions at leading nonprofit, public, and social enterprise organizations;Provides monthly trainings with a cohort of peers;Matches Fellows with a coach and;Provides a network to support career growth during the Fellowship and beyond.Open to US citizens or work authorization. ProInspire partners are unable to provide sponsorship for the fellowship year.",
	...
	"Details": "Project GO provides fully funded scholarships to ROTC students to participate in critical language study programs domestically and overseas. Full funding for participation, including tuition, room and board, textbooks, visas, insurance, and travel expenses to and from the study destination. Must demonstrate a commitment to ROTC and language study. An ROTC Commander reference is required.",
	...
	"Details": "A Masters level scholarship providing a full tuition-fee waiver to an exceptional female student from the United States who wishes to pursue study in a field related to politics, conflict transformation or human rights. The five M.A. programs covered by the award will include:",
	...
	"Details": "The Randy Pausch Scholarship was established by the Academy of Interactive Arts & Sciences in 2008 to honor the memory of Computer Science Professor and Co-Founder of the Entertainment Technology Center at Carnegie Mellon University, Dr. Randy Pausch. Applicants to the Randy Pausch Scholarship must intend to pursue a career in any aspect of game development including: art, animation, programming, engineering, game direction, game design, sound design, and music composition.",
	...
	"Details": "The Robert H. N. Ho Family Foundation Dissertation Fellowships in Buddhist Studies provide one-year stipends to PhD candidates for full time preparation of dissertations.  The fellowship period may be used for fieldwork, archival research, analysis of findings, or for writing after research is complete.",
	...
	"Details": "Through academic training, practice, and global networking opportunities, the Rotary Peace Centers program develops leaders who become catalysts for peace and conflict prevention and resolution. Each year, Rotary selects up to 100 individuals from around the world to receive fully funded academic fellowships at one of our peace centers. These fellowships cover tuition and fees, room and board, round-trip transportation, and all internship and field-study expenses.In just over a decade, the Rotary Peace Centers have trained more than 900 fellows for careers in peace building. Many of them go on to serve as leaders in national governments, NGOs, the military, law enforcement, and international organizations like the United Nations and World Bank.",
	...
	"Details": "The purpose of this Kirschstein-NRSA pre-doctoral fellowship (F31) award is to enhance the diversity of the health-related research workforce by supporting the research training of pre-doctoral students from population groups that have been shown to be underrepresented in the biomedical, behavioral, or clinical research workforce. Such individuals include those from underrepresented racial and ethnic groups, those with disabilities, and those from disadvantaged backgrounds. Through this award program, promising pre-doctoral students will obtain individualized, mentored research training from outstanding faculty sponsors while conducting well-defined research projects in scientific health-related fields relevant to the missions of the participating NIH Institutes and Centers. The proposed mentored research training is expected to clearly enhance the individuals potential to develop into a productive, independent research scientist.",
	...
	"Details": "EPAs Science To Achieve Results (STAR) graduate fellowship program supports masters and doctoral candidates in environmental studies. Each year, students in the United States compete for STAR fellowships through a rigorous review process. Students can pursue degrees in traditionally recognized environmental disciplines as well as other fields such as social anthropology, urban and regional planning, and decision sciences. Since the program began in 1995, EPA has awarded approximately 1,884 STAR fellowships to students in every state and most territories. Fellowships have helped educate new academic researchers, government scientists, science teachers and environmental engineers.",
	...
	"Details": "In 2010, SQCC established its Research Fellowship Program, which aims to promote and cultivate scholarly research about Oman across several academic disciplines. The fellowship is open to PhD candidates and university academics who are US citizens or affiliated with an American university, and funds one scholar or team of scholars to carry out research in Oman each year. The fellowship awards up to $51,000 for the fellow or team of fellows to conduct research in Oman for up to one year.",
	...
	"Details": "The Mellon International Dissertation Research Fellowship (IDRF) offers nine to twelve months of support to graduate students in the humanities and humanistic social sciences who are enrolled in PhD programs in the United States and conducting dissertation research on non-US topics. Eighty fellowships are awarded annually. Fellowship amounts vary depending on the research plan, with a per-fellowship average of $20,000. The fellowship includes participation in an SSRC-funded interdisciplinary workshop upon the completion of IDRF-funded research.",
	...
	"Details": "Teach For America is the national corps of top college graduates and professionals who commit to teach for two years in urban and rural public schools and become lifelong leaders in the effort to expand educational opportunity. Teach For Americas network includes more than 10,000 corps members teaching in 46 regions across the country and nearly 28,000 alumni working in education and many other sectors to create the systemic changes that will help end educational inequity.",
	...
	"Details": "African Americans hold less than three percent of PhDs in biology, chemistry and engineering today. Opportunities created by UMSI aim to increase the numbers of minority students in sciences and engineering. Fellowship funds for tuition, room and board, plus institutional support to the department of award recipients.",
	...
	"Details": "The USC Shoah Foundation Center for Advanced Genocide Research invites research proposals from USC undergraduate students for its 2018 Summer Research Fellowships.",
	...
	"Details": "Scholarships listed vary by term.",
	...
	"Details": "Award to assist with costs for summer research related to Classics in the United States or internationally.",
	...
	"Details": "Dornsife Scholars are students whose academic achievements underscore the relationship between excellence in the core disciplines of letters, arts, and sciences (either in the humanities, social sciences or sciences) and the aspiration to have a positive impact on the world. Dana and David Dornsife are internationally renowned philanthropists with the highest regard for education. Dornsife Scholars will be expected to demonstrate a comparable commitment to educational excellence and the advances that allow for improving the lives of people and addressing pressing global challenges.",
	...
	"Details": "The Department of Classics offers multiple awards to assist with costs for travel and research for a project of study about the classical world.",
	...
	"Details": "FLAS fellowships are provided by a U.S. Department of Education Title VI grant for undergraduate and graduate study of Mandarin Chinese, Japanese or Korean and East Asian area studies. The purpose of the program is to enrich the nations pool of area and international specialists. Applicants should be planning to use their training to teach, to serve in government or international agencies, or to engage in other work that advances American understanding of other countries.*FLAS fellowships are contingent upon funding from the U.S. Department of Education.Summer FLAS Award (2017 - $5,000 tuition and $2,500 stipend) and Academic Year (2017-18 - $10,000 tuition and $5,000 stipend undergraduate; $18,000 tuition and $15,000 stipend graduate).",
	...
	"Details": "A variety of endowed fellowships are available for current PhD students who are making good progress to the degree in terms of both quality of work and timing, and who can provide a compelling statement about their current or planned research.",
	...
	"Details": "Research Enhancement Fellowships provide additional opportunities for outstanding PhD students in any field whose research requires work in particularly complex or distant settings, expertise in languages classified by the federal government as less commonly taught, or other unusual activities that are essential for the students research.",
	...
	"Details": "Each year, USC Marshall awards a number of scholarships to outstanding undergraduate students. Awards recognize academic excellence and/or outstanding service, and provide tuition funding for one academic year only. All students who submit a complete scholarship application will be considered for general awards being offered. However, please note that some awards have specific eligibility requirements which are set by the donors who fund the scholarship.",
	...
	"Details": "The School of Architecture awards annual merit scholarships to continuing architecture students.   Incoming students should contact the Universitys Office of Admission and Financial Aid for opportunities.",
	...
	"Details": "The website lists many of the scholarships offered primarily to continuing students by the School of Cinematic Arts. In addition to these awards, additional scholarships may be available in any given year.",
	...
	"Details": "The SOAR program provides funding to Dornsife undergraduates for participation as a research assistant in a faculty members project. The purpose of SOAR is to connect students with faculty members and their research; it allows all students to be mentored one-on-one by USC faculty, introduces students early in their academic careers to the process of serious scholarly inquiry, and fosters valuable relationships between students and faculty. Please note that we do not fund independent research projects, including those related to 490 courses or honors theses.For students interested in summer undergraduate research funding, please visit the SURF/SHURE page. Students interested in pursuing independent research should apply for PURF, the Provosts Undergraduate Research Fund, instead.SOAR is for research during the fall and spring semesters of the academic year. Funding applications are accepted for the first five weeks of fall (fall deadline September 20, 2017) and the first three weeks of spring semester (spring deadline January 24, 2017). Must not have already received the maximum SOAR grant during the academic year for which you are applying. Up to $1000 can be awarded per student, per academic year, regardless of whether it will be used for one semester or spanning both fall and spring semesters. A recipient of the Provost Fellowship (PURF) will not be contemporaneously considered for a SOAR grant (likewise with other funding; a students total funding sources should not exceed $1000).",
	...
	"Details": "The goal of this program is to introduce undergraduates to the experience of conducting research within the academe while still at an early stage in their academic careers and to assist them in forging mentoring relationships. WiSE Fellows\u009d submit an application describing their interests and objectives in participating in the program. Once accepted, they receive a small stipend of $500 per semester and commit to attending a variety of programming opportunities aimed especially at demystifying the research process, assisting students in locating appropriate mentors given their research interests, highlighting undergraduate research funding opportunities at USC, and locating appropriate Research Experiences for Undergraduates (REUs).",
	...
	"Details": "The annual USGIF Scholarship Program recognizes the achievements of graduating high school seniors, undergraduate, graduate, and doctoral students.USGIF has awarded $891,000 in scholarships since launching the program in 2004. The Scholarship Program is funded by USGIF Memberships and the annual Allder Golf Classic, named in honor of William R. Allder Jr.",
